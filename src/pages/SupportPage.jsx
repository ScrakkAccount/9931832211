...
const SupportPage = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 sm:py-12 px-4">
      ...
      >
        <HelpCircle className="h-16 w-16 sm:h-20 sm:w-20 text-primary mx-auto mb-4 sm:mb-6" />
        <h1 className="text-4xl sm:text-5xl font-extrabold mb-3 sm:mb-4 gradient-text">Centro de Soporte</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-10">
        {contactOptions.map((option, index) => (
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="p-6 sm:p-8 rounded-xl glassmorphism shadow-xl hover:shadow-2xl transition-shadow duration-300 flex flex-col"
          >
            ...
            <p className="text-muted-foreground leading-relaxed mb-5 sm:mb-6 flex-grow">{option.description}</p>
            <Button
      ...
      <motion.div
        ...
        className="mt-10 sm:mt-16 p-6 sm:p-8 rounded-xl glassmorphism shadow-lg text-center"
      >
        <h3 className="text-xl sm:text-2xl font-semibold mb-3 text-foreground">Horario de Soporte</h3>
